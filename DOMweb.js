...
const catForm = document.querySelector("#breed-form");
// Requirement 3: Use parent-child-sibling relationships
//const formParent = catForm.parentNode;

//Requirement 7: Create a DocumentFragment for the site
...
mainEl.innerHTML = '<h1>Adopt A cat/kitten today </h1>';
...
var menuLinks = [
    ...
    {text: 'catalog', href: '#', subLinks: [
      ...
      {text: 'top adoptees', href: '/catalog/top'},
